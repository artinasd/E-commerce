...
export default function CheckoutForm({ addresses, cart }) {
  ...
  async function placeOrder() {
    ...
    try {
      ...
      const orderId = checkoutPayload?.data?.order?.id;
