      ...
      <div className="store-shell">
        <div className="flex h-[76px] items-center gap-3">
          ...
          <div className="mr-auto flex items-center gap-1.5 lg:mr-0">
            <Link href="/account" className="hidden h-11 items-center gap-2 border border-[var(--border)] bg-white px-4 text-[13px] font-bold transition hover:border-slate-300 hover:bg-slate-50 sm:inline-flex">ورود / ثبت‌نام</Link>
        ...
        {searchOpen && (
          <div className="border-t border-[var(--border)] py-3 md:hidden">
            <form action="/products">
              <input autoFocus name="search" className="h-11 w-full border border-[var(--border)] bg-[#f3f3f1] px-4 text-sm outline-none focus:bg-white" placeholder="جستجوی محصول، برند یا دسته‌بندی" aria-label="جستجو" />
            </form>
          </div>
        )}
      </div>
