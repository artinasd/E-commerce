  ...
  return (
    <div className="store-shell py-6 sm:py-9">
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[240px_minmax(0,1fr)]">
        <aside className="order-2 lg:order-1"><div className="sticky top-24 border border-[var(--border)] bg-white p-5">
          ...
          <form method="get" className="space-y-5 pt-4">
            ...
            <button type="submit" className="h-10 w-full bg-slate-950 text-[10px] font-black text-white transition hover:bg-[var(--brand)]">اعمال فیلتر</button>
          </form>
        </div></aside>

        <section className="order-1 min-w-0 lg:order-2">
          <div className="mb-4 flex items-center justify-between gap-3"><p className="text-[10px] font-bold text-slate-400"><span className="font-black text-slate-700">{result.pagination?.total || 0}</span> محصول</p><p className="text-[9px] font-bold text-slate-400">صفحه {page}</p></div>
